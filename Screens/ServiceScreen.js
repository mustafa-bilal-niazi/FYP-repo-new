...
import { RefreshControl, TouchableOpacity,SafeAreaView ,TextInput,Pressable, Modal ,Button, StyleSheet, Text, View,Image } from 'react-native'
...
function Planner({navigation}) {
  return (
    <View style={styles.container}>
        ...
        <Image style={[styles.image,{marginTop:50}]} source={require('../assets/Meals.png')} /> 
        <View style={styles.buttonContainer}>
...
function VRtrainer({navigation}) {
  ...
  return (
    ...
    <TouchableOpacity
  //onPress={() => navigation.navigate(('Ptracker'))}
  ...
  function Ratings() {
    ...
    return (
      ...
      <Drawer.Screen name="Home" component={TabScreens} options={{
        title: 'Home',
        headerStyle: {
